              ...
              <div className="notification-scroll">
                <div className="dropdown-item">
                  <div className="media server-log">
                    <img
                      src="/assets/img/profile-16.jpeg"
                ...
                <div className="dropdown-item">
                  <div className="media ">
                    <img
                      src="/assets/img/profile-15.jpeg"
                      className="img-fluid me-2"
                      alt="avatar"
                    />
                    <div className="media-body">
