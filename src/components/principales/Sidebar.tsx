        ...
        <div className="sidebar-wrapper sidebarsidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul className="list-unstyled menu-categories" id="accordionExample">
                    <li className="menu">
                        <a href="#dashboard" data-bs-toggle="collapse" aria-expanded="false" className="dropdown-toggle">
                            <div className="">
                        ...
                        <ul className="collapse submenu list-unstyled" id="dashboard" data-bs-parent="#accordionExample">
                            <li>
                    ...
                    <li className="menu active">
                        <a href="#layouts" data-bs-toggle="collapse" aria-expanded="true" className="dropdown-toggle">
                            <div className="">
                        ...
                        <ul className="collapse submenu list-unstyled show" id="layouts" data-bs-parent="#accordionExample">
                            <li>
